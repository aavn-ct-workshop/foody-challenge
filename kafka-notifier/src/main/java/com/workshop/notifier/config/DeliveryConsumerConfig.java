...
public class DeliveryConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, Delivery> consumerDeliveryFactory() {
        ...
        return new DefaultKafkaConsumerFactory<>(
            ...
            new JsonDeserializer<>(Delivery.class)
        );
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, Delivery> kafkaDeliveryListenerContainerFactory() {
